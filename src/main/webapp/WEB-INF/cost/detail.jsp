        ...
        <div id="main">            
            <form action="" method="" class="main_form">
                ...
                <div class="input_info fee_type">
                    <input type="radio" name="radFeeType" <c:if test="${cost.costType==1}">checked="checked"</c:if> id="monthly" disabled="disabled" />
                    <label for="monthly">包月</label>
                    <input type="radio" name="radFeeType" <c:if test="${cost.costType==2}">checked="checked"</c:if> id="package" disabled="disabled" />
                    <label for="package">套餐</label>
                    <input type="radio" name="radFeeType" <c:if test="${cost.costType==3}">checked="checked"</c:if> id="timeBased" disabled="disabled" />
                ...
                <div class="input_info"><input type="text"  class="readonly" readonly value="<fmt:formatDate value='${cost.creatime}' pattern='yyyy年MM月dd日 HH:mm:ss'/>" /></div>      
                <div class="text_info clearfix"><span>启动时间：</span></div>
                <div class="input_info"><input type="text"  class="readonly" readonly value="<fmt:formatDate value='${cost.startime}' pattern='yyyy年MM月dd日 HH:mm:ss'/>" /></div>      
